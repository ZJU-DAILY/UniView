CREATE MATERIALIZED VIEW IF NOT EXISTS mv325
...
FROM
	...
	Join web_site
WHERE
	(((date_dim.d_date >= cast('1970-01-01' as date) + interval 11192 days) AND (date_dim.d_date <= cast('1970-01-01' as date) + interval 11222 days)))
