CREATE MATERIALIZED VIEW IF NOT EXISTS mv134
...
FROM
	...
	item
WHERE
	(((date_dim.d_date >= cast('1970-01-01' as date) + interval 10983 days) AND (date_dim.d_date <= cast('1970-01-01' as date) + interval 11073 days)))
