CREATE MATERIALIZED VIEW IF NOT EXISTS mv288
...
WHERE
	...
	AND (((store.s_county = 'Williamson County') OR (store.s_county = 'Franklin Parish') OR (store.s_county = 'Bronx County') OR (store.s_county = 'Orange County')))
