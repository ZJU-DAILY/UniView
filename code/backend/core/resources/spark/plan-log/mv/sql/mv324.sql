SELECT
	...
	date_dim.d_date_sk
FROM
	web_sales LEFT JOIN web_returns ON (web_sales.ws_order_number = web_returns.wr_order_number AND web_sales.ws_item_sk = web_returns.wr_item_sk)	Join web_site
	Join date_dim
WHERE
