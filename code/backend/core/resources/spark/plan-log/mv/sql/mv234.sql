...
FROM
	...
	item
WHERE
	(((item.i_brand = 'scholaramalgamalg #14') OR (item.i_brand = 'scholaramalgamalg #7') OR (item.i_brand = 'exportiunivamalg #9') OR (item.i_brand = 'scholaramalgamalg #9') OR (item.i_brand = 'amalgimporto #1') OR (item.i_brand = 'edu packscholar #1') OR (item.i_brand = 'exportiimporto #1') OR (item.i_brand = 'importoamalg #1')))
