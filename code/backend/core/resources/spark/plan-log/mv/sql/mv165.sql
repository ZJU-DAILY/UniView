SELECT
	...
	warehouse.w_country
FROM
	catalog_sales LEFT JOIN catalog_returns ON (catalog_sales.cs_item_sk = catalog_returns.cr_item_sk AND catalog_sales.cs_order_number = catalog_returns.cr_order_number)	Join warehouse
WHERE
